...
@NamedQueries({@NamedQuery(name = "Historico.findByIdAluno", query = "SELECT h FROM Historico h WHERE h.historicoPK.idAluno = :idAluno"), 
@NamedQuery(name = "Historico.findByIdDisciplina", query = "SELECT h FROM Historico h WHERE h.historicoPK.idDisciplina = :idDisciplina"), 
@NamedQuery(name = "Historico.findByAprovado", query = "SELECT h FROM Historico h WHERE h.aprovado = :aprovado")})
