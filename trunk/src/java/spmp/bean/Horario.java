...
@Entity
@Table(name = "horario")
@NamedQueries({@NamedQuery(name = "Horario.findByIdTurma", query = "SELECT h FROM Horario h WHERE h.horarioPK.idTurma = :idTurma"), @NamedQuery(name = "Horario.findByDiaSemana", query = "SELECT h FROM Horario h WHERE h.horarioPK.diaSemana = :diaSemana"), @NamedQuery(name = "Horario.findByHoraInicio", query = "SELECT h FROM Horario h WHERE h.horarioPK.horaInicio = :horaInicio"), @NamedQuery(name = "Horario.findByHoraFim", query = "SELECT h FROM Horario h WHERE h.horarioPK.horaFim = :horaFim")})
